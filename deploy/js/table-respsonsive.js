...
$( "tr td:nth-child(1)" ).prepend( "<span>" + one + "</span>" );
$( "tr td:nth-child(2)" ).prepend( "<span>" + two + "</span>" );
$( "tr td:nth-child(3)" ).prepend( "<span>" + three + "</span>" );
$( "tr td:nth-child(4)" ).prepend( "<span>" + four + "</span>" );
$( "tr td:nth-child(5)" ).prepend( "<span>" + five + "</span>" );
$( "tr td:nth-child(6)" ).prepend( "<span>" + six + "</span>" );
$( "tr td:nth-child(7)" ).prepend( "<span>" + seven + "</span>" );
$( "tr td:nth-child(8)" ).prepend( "<span>" + eight + "</span>" );
$( "tr td:nth-child(9)" ).prepend( "<span>" + nine + "</span>" );
$( "tr td:nth-child(10)" ).prepend( "<span>" + ten + "</span>" );
